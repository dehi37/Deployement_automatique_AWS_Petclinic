...
module "cloudfront" {
  ...
  certificate_arn          = null # var.certificate_arn != "" ? var.certificate_arn : module.iam.certificate_arn
  web_acl_arn              = null # module.waf.web_acl_arn
  aws_region               = var.aws_region
